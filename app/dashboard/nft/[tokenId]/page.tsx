...
import { createClient } from '@/lib/supabase/client'// app/dashboard/nft/[tokenId]/page.tsx
'use client'
...
export default function NFTDetail() {
  ...
  // ✅ FIXED: Updated handleShare function
  const handleShare = (platform: string) => {
    ...
    const shareUrls: Record<string, string> = {
      ...
      copy: 'copy' // Special case handled separately
    }
...
export default function NFTDetail() {
  ...
  const handleShare = (platform: string) => {
    ...
    else window.open(urls[platform as keyof typeof urls], '_blank')
  }
