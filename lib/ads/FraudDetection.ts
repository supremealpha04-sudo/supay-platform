...
// ============================================================
// FIX: Extend Window and Navigator interfaces for TypeScript
// ============================================================
declare global {
  interface Window {
    callPhantom?: any;
...
class FraudDetectionService {
  ...
  detectVirtualMachine(): boolean {
    const vmIndicators = [
      ...
      navigator.deviceMemory !== undefined && navigator.deviceMemory < 4, // FIX: Now TypeScript recognizes deviceMemory
    ]
